                ...
                <form onSubmit={handleSignup} className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <p className="text-slate-600 dark:text-slate-400 text-lg">
                      Join TalkIn and start your language learning adventure!
                    </p>
                  </div>
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        <input 
                          type="checkbox" 
                          className="mt-1 w-4 h-4 text-blue-600 bg-white/50 border-slate-300 rounded focus:ring-blue-500 focus:ring-2" 
                          required 
                        />
              ...
              <div className="max-w-md p-8 text-center relative z-10">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-slate-600 dark:text-slate-400 text-lg leading-relaxed">
                    Connect with language partners worldwide and start your learning journey today
                  </p>
